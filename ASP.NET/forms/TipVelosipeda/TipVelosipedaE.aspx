...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="TipVelosipedaE.aspx.cs" Inherits="IIS.Прокат_велосипедов_2.ТипВелосипедаE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="<%= Constants.FormCssClass + " " +  Constants.EditFormCssClass %>">
        <h2 class="<%= Constants.FormHeaderCssClass + " " + Constants.EditFormHeaderCssClass %>">Тип велосипеда</h2>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlТекущаяСтоимостьLabel" runat="server" Text="Текущая стоимость" EnableViewState="False">
</asp:Label>
<ac:DecimalTextBox CssClass="descTxt" ID="ctrlТекущаяСтоимость" runat="server">
</ac:DecimalTextBox>

<asp:RequiredFieldValidator ID="ctrlТекущаяСтоимостьRequiredFieldValidator" runat="server" ControlToValidate="ctrlТекущаяСтоимость"
                            ErrorMessage="Не указано: ТекущаяСтоимость" Text="*" 
                            EnableClientScript="true" ValidationGroup="savedoc" />
...
<div style="clear: left">
	<ac:AjaxGroupEdit ID="ctrlИсторияРасценок" runat="server" ReadOnly="false" />
</div>
<br/>
