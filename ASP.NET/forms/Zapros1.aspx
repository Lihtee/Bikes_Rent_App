...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Zapros1.aspx.cs" Inherits="IIS.Прокат_велосипедов_2.Запрос1" Title="Untitled Page" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder0" runat="server">
    ...
    <script type="text/javascript">
        ...
        function requestAndDraw() {
            ...
            $.ajax({
                url: "Zapros1.aspx/BestWorstRequest_1",
                type: "POST",
        ...
        function drawChart(_resObj) {
            if (_resObj != null) {
                ...
                // Set chart options
                var options = {
                    'title': 'Рейтинг типов велосипедов',
                    'width': 400,
                    'height': 300
                };
