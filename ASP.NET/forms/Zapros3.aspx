...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="main">
        <div class="requestBlock">
            <p class ="header">Сколько велосипедов было испорчено или украдено?</p>
            <p> 
                Испорчено: <b class="res" id="spoiled" runat="server"></b>
            </p>
            <p>
                Украдено <b class="res" id="stolen" runat="server"></b>
            </p>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder0" runat="server">
    ...
    <script type="text/javascript">
        ...
        function requestAndDraw() {
            ...
            $.ajax({
                url: "Zapros3.aspx/BestWorstRequest_1",
                type: "POST",
        ...
        function drawChart(_resObj) {
            if (_resObj != null) {
                var spoiled = _resObj.rows[0][0];
                var stolen = _resObj.rows[0][1];

                document.getElementById("<%=spoiled.ClientID%>").innerHTML = spoiled;
                document.getElementById("<%=stolen.ClientID%>").innerHTML = stolen;
            }
      }
    </script>
</asp:Content>
