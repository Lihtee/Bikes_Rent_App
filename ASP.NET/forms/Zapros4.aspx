...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Zapros4.aspx.cs" Inherits="IIS.Прокат_велосипедов_2.Запрос4" Title="Untitled Page" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="main">
        <div class="requestBlock">
            <p class ="header">Перевозки велосипедов</p>
            <%--<p> 
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder0" runat="server">
    ...
    <script type="text/javascript">
        ...
        function requestAndDraw() {
            ...
            $.ajax({
                url: "Zapros4.aspx/BestWorstRequest_1",
                type: "POST",
        ...
        function drawChart(_resObj) {
            if (_resObj != null) {
                ...
                // Set chart options
                var options = {
                    'title': 'Количество перевозок велоспедов',
                    'width': 400,
                    'height': 300
                };
