...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Zapros5.aspx.cs" Inherits="IIS.Прокат_велосипедов_2.Запрос5" Title="Untitled Page" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="main">
        <div class="requestBlock">
            <p class ="header">Средняя длительность проката</p>
            <%--<p> 
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder0" runat="server">
    ...
    <script type="text/javascript">
        ...
        function requestAndDraw() {
            ...
            $.ajax({
                url: "Zapros5.aspx/BestWorstRequest_1",
                type: "POST",
        ...
        function drawChart(_resObj) {
            if (_resObj != null) {
                ...
                // Set chart options
                var options = {
                    'title': 'Средняя продолжительность прокатов',
                    'width': 1000,
                    'height': 300
                };
